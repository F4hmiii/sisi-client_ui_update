    ...
    const expenseCard = expensesBreakdowns.map((expensesBreakdown) => (
        <div key={expensesBreakdown.id} className="flex pb-4 justify-between">
            <div className="flex">
                ...
                <div className="ms-4">
                    <span className="text-[color:var(--text-secondary)]">{expensesBreakdown.category}</span>
                    <br />
                    <span className="font-bold text-lg text-[color:var(--text-color)]">${expensesBreakdown.amount}</span>
                    <div className="flex">
